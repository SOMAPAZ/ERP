...
(() => {
  ...
  const renderizarDeuda = () => {
    ...
    if(resDebt.estado === 'debe') {
      ...
      divPeriodo.className = "rounded-lg border dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow w-full mx-auto px-4 md:px-10 py-6";
    ...
    divDeuda.className = "rounded-lg border dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow w-full mx-auto px-4 md:px-10 py-6 mt-6";
    ...
    btnPagar.className = "py-2 px-4 bg-gray-100 dark:bg-gray-700 rounded text-sm text-gray-800 dark:text-white my-4 hover:bg-gray-200 dark:hover:bg-gray-600 font-semibold flex flex-row gap-2 items-center uppercase";
