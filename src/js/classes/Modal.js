export default class Modal {
    static styledModal(content, buttons) {
        ...
        btnCloseModal.className = 'absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center uppercase tracking-widest';
    ...
    static renderModal(contenido, btn) {
        ...
        btnClose.className = 'py-2 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 uppercase tracking-widest';
    ...
    static simpleRenderModal(content) {
        ...
        const btnClose = document.createElement('BUTTON');
        btnClose.className = 'text-indigo-700 hover:text-white border border-indigo-700 hover:bg-indigo-800 focus:outline-none font-medium rounded-lg text-sm uppercase px-5 py-2.5 text-center me-2 mb-2 dark:border-indigo-500 dark:text-indigo-500 dark:hover:text-white dark:hover:bg-indigo-500 tracking-widest';
        btnClose.textContent = 'Cerrar';
        btnClose.onclick = () =>  {
            document.querySelector('.default-modal').classList.add('opacity-0');
            setTimeout(() => document.querySelector('.default-modal')?.remove(), 300);
