...
<section class="bg-white py-4 antialiased dark:bg-gray-900 md:py-8 h-auto">
    <article class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        <div class="lg:flex lg:items-center lg:justify-between lg:gap-4">
            <h2 class="shrink-0 font-black text-xl text-gray-900 dark:text-white sm:text-4xl uppercase text-center">Reporte de Lecturas</h2>
        </div>
        <div class="space-y-2 sm:space-y-0 flex justify-end sm:flex-row gap-2 mt-2">
            <a href="/agendalec" class="inline-flex w-full sm:w-auto justify-center items-center gap-2 bg-indigo-600 text-white px-4 py-2 text-xs text-center font-bold uppercase rounded hover:bg-indigo-500">
        ...
        <form class="mt-6" id="formulario-notificaciones" autocomplete="off" method="POST">
                    ...
                    <div class="grid gap-6 md:grid-cols-3 w-full">
                        <div class="flex flex-col col-span-1">
                            ...
                            <input type="number" id="idUser" name="idUser" placeholder="7777"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white p-2.5 uppercase w-full" disabled />
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" id="observaciones" name="observaciones" placeholder="103" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white p-2.5 uppercase" disabled />
                        </div>
                    </div>
                </section>
                <section class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 ">
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white mt-5">Datos de Lecturas</h2>
                    <div class="grid gap-6 md:grid-cols-3">
                        <div class="flex flex-col mt-5 w-full">
                            <label for="select-año" class="text-sm font-medium text-gray-700 dark:text-gray-200">Año</label>
                            <select id="select-año" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white p-2.5 uppercase w-full">
                                <option value="">Seleccione un año</option>
                            </select>
                        </div>
                        <div class="flex flex-col mt-5 w-full">
                            <label for="select-mes" class="text-sm font-medium text-gray-700 dark:text-gray-200">Mes</label>
                            <select id="select-mes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white p-2.5 uppercase w-full">
                        ...
                        <div class="flex flex-col mt-4">
                            ...
                            <input type="file" id="evidencia" name="evidencia" accept="image/*"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white p-2.5 uppercase w-full" />
                        </div>
                    </div>
                    <div class="flex flex-col items-center mt-6 space-y-6">
                        <div class="w-full flex flex-col mt-5">
                            <label for="lectura" class="text-lg font-medium text-gray-900 dark:text-white mb-2">Ingrese la Lectura:</label>
                            <input type="text" id="lectura" name="lectura" min="0" max="99999" step="0.0001" value=""
                                class="text-center text-lg font-semibold bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg shadow-md focus:ring-indigo-500 focus:border-indigo-500 p-3 w-full" /> <!-- Cambié w-40 a w-full -->
                        </div>
                        <div id="medidor" class="flex gap-3 mt-4 p-4 rounded-lg bg-gray-200 dark:bg-gray-800 shadow-lg border border-gray-300 dark:border-gray-700 overflow-auto max-w-full whitespace-nowrap">
                        </div>
...
<?php $scripts = ['notificacion/formLec.js']; ?>