    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="lg:flex lg:items-center lg:justify-between lg:gap-4">
            <h2 class="shrink-0 font-black text-xl text-gray-900 dark:text-white sm:text-4xl text-center cursor-pointer">
                Reporte de Lectura <span class="font-normal"></span>
            </h2>
        </div>
        ...
        <div class="py-2 lg:py-4">
            ...
            <dl class="grid sm:grid-cols-2 md:grid-cols-4 gap-4 items-center">
                ...
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Id Medidor:</dt>
                    <dd id="idmedidor" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Estado de la lectura:</dt>
                    <dd id="status" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400">
                    </dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Año:</dt>
                    <dd id="year" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Mes:</dt>
                    <dd id="mes" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Lectura:</dt>
                    <dd id="lectura" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Consumo Global:</dt>
                    <dd id="cglobal" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Fecha Registrada:</dt>
                    <dd id="fechregistrada" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Fecha de Finalizacion:</dt>
                    <dd id="fechfinalizacion" class="mb-2 md:mb-4 font-light text-gray-500 dark:text-gray-400"></dd>
                </div>
                <div>
        ...
        <div class="grid gap-2 md:grid-cols-1 text-center justify-between">
           ...
           <div id="imgModal" style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); display: none; justify-content: center; align-items: center; z-index: 50;">
...
<?php $scripts = ['notificacion/consultalec.js']; ?>