    ...
    <article class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg">
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <button class="py-2 px-4 bg-gray-100 dark:bg-gray-700 rounded text-sm text-gray-800 dark:text-white
                    my-4 hover:bg-gray-200 dark:hover:bg-gray-600 font-semibold flex flex-row gap-2 items-center" id="btn-pago-parcial">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6"><path d="M12 7.5a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z" /><path fill-rule="evenodd" d="M1.5 4.875C1.5 3.839 2.34 3 3.375 3h17.25c1.035 0 1.875.84 1.875 1.875v9.75c0 1.036-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 0 1 1.5 14.625v-9.75ZM8.25 9.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM18.75 9a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V9.75a.75.75 0 0 0-.75-.75h-.008ZM4.5 9.75A.75.75 0 0 1 5.25 9h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V9.75Z" clip-rule="evenodd" /><path d="M2.25 18a.75.75 0 0 0 0 1.5c5.4 0 10.63.722 15.6 2.075 1.19.324 2.4-.558 2.4-1.82V18.75a.75.75 0 0 0-.75-.75H2.25Z" /></svg>
                    Pagar
                </button>
                <button class="py-2 px-4 bg-transparent rounded text-sm text-gray-800 dark:text-white
                    my-4 font-semibold flex flex-row gap-2 items-center" id="btn-condonar-parcial">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6"><path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm3 10.5a.75.75 0 0 0 0-1.5H9a.75.75 0 0 0 0 1.5h6Z" clip-rule="evenodd" /></svg>Condonar
                </button>
            </div>
            ...
            <div id="radio_inputs" class="grid selection:sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-5">
                <div class="flex flex-row gap-3 border border-dashed border-gray-400 px-4 py-1 rounded-lg items-center dark:bg-gray-700 dark:text-gray-300 text-xs uppercase font-black">
