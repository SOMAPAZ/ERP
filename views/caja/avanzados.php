    ...
    <article class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div class="relative sm:rounded-lg">
            ...
            <div class="flex flex-col md:flex-row gap-4 md:gap-8">
                <button class="py-2 px-4 bg-red-700 rounded text-sm text-white md:my-4 hover:bg-red-800 dark:hover:bg-red-600 font-semibold flex flex-row gap-2 items-center" id="btn-calcular-parcial">
                ...
                <div class="hidden flex-col md:flex-row gap-4 md:gap-8" id="div-btn-acciones">
                    ...
                    <button type="button" id="realizar-desc" class="py-2 px-4 bg-transparent rounded text-sm text-gray-800 dark:text-white
                        md:my-4 font-semibold flex flex-row gap-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>
                        Descuento Recargos
                    </button>
                    <button type="button" id="eliminar-desc" class="hidden text-red-800 dark:text-white flex items-center justify-center sm:w-full md:w-auto uppercase text-xs py-2 px-6 rounded-sm gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div id="monto-seleccionado" class="mt-5 md:mt-0 bg-white dark:bg-gray-700 mb-5 dark:text-white text-xl p-2 rounded text-center shadow border border-dashed font-semibold uppercase">
                <p>Sin meses seleccionados</p>
            </div>
            ...
            <form class="w-full p-4 bg-white dark:bg-gray-800 border border-dashed border-gray-400 rounded-lg space-y-5 mb-5" id="notas-form">
...
<?php $scripts = ['caja-cobro/avanzados_v3.js', 'caja-cobro/adicional_v3.js']; ?>