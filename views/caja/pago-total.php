...
<section class="bg-white py-4 antialiased dark:bg-gray-900 md:py-8 h-auto">
    ...
    <article class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        <div class="lg:flex lg:flex-col lg:items-center lg:gap-4">
            ...
            <form class="w-full mx-auto mt-5 space-y-5 font-semibold border border-dashed border-gray-400 rounded-lg p-6 shadow-lg text-lg dark:border-gray-700 dark:bg-gray-800 dark:text-white" id="formulario-pago" autocomplete="off">
