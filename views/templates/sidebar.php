<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0">
    <div class="h-full px-3 py-4 overflow-y-auto bg-indigo-600 dark:bg-indigo-950">
        ...
        <ul class="font-medium md:border-t border-indigo-200">
            <p class="text-sm text-white pt-5 text-center">
        ...
        <ul class="space-y-2 font-medium my-5 mt-5 border-y border-indigo-200">
            <?php if ($_SESSION['empleado_rol'] === "1" || $_SESSION['empleado_rol'] === "3") : ?>
                <li>
                    <a href="/general" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
            ...
            <?php endif; ?>
            <li>
                <a href="/usuarios" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/agreements" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <li>
                <a href="/notificaciones" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <?php if ($_SESSION['empleado_rol'] === "1" || $_SESSION['empleado_rol'] === "3" || $_SESSION['empleado_rol'] === "8" || $_SESSION['empleado_rol'] === "2") : ?>
                <li>
                    <a href="/consultar" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <?php endif; ?>
            <li>
                <a href="/reportes?s=1" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <li>
                <a href="/tanks" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <li>
                <a href="/sdd" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <li>
                <a href="/updates" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
            ...
            <li>
                <a href="/data-view" class="flex items-center p-2 rounded-lg text-white hover:bg-indigo-700 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 text-white">
