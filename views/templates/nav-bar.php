<div class="bg-gray-50 dark:bg-gray-800 shadow-md">
    <div class="container mx-auto flex flex-col-reverse md:flex-row justify-end items-center gap-4 py-3 text-sm font-medium uppercase px-4">
        <div id="apartados" class="text-center gap-6 flex flex-row md:justify-between">
            <button id="btn-menu" type="button" class="flex flex-row gap-2 items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <div class="hidden md:flex md:gap-4">
                <?php foreach ($links as $link): ?>
                    <a href="/<?= $link; ?>" class="bg-gray-100 px-4 py-2 rounded-md font-semibold text-gray-700 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-white cursor-pointer"><?= str_replace('-', ' ', $link); ?></a>
                <?php endforeach; ?>
            </div>
            <div>
