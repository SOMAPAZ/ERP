...
<section class="bg-white py-4 antialiased dark:bg-gray-900 md:py-8 h-auto">
    <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        ...
        <div id="filtros-radio" class="flex justify-between flex-wrap w-full gap-4 border-y border-gray-200 dark:border-gray-700">
            ...
            <?php if(
            $_SESSION['empleado_rol'] !== '5' &&
            $_SESSION['empleado_rol'] !== '6' &&
            $_SESSION['empleado_rol'] !== '7' ) : ?>
                <div class="flex items-center py-2">
                ...
                <div class="flex items-center py-2">
                    <a id="terminados" href="/reportes?s=4" class="ms-2 text-sm font-black text-gray-900 dark:text-gray-300 cursor-pointer uppercase hover:text-indigo-800 hover:underline <?= $_SESSION['empleado_rol'] === '1' || $_SESSION['empleado_rol'] === '3' ? '' : 'hidden' ?>">Terminado</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-6 flow-root">
            ...
            <div id="paginacion" class="border-t mt-5 p-4 shadow-md flex justify-between items-center uppercase font-bold dark:text-white gap-2">
...
<?php $scripts = ['reportes/mostrar-reportes_v1-1-3.js']; ?>  