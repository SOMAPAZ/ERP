        ...
        <div class="py-2 lg:py-4">
            ...
            <dl class="grid sm:grid-cols-2 md:grid-cols-4 gap-4 items-center">
                ...
                <div>
                    ...
                    <input type="hidden" name="incidencia" id="incidencia-id" value="<?= $incidencia->id ?>">
                </div>
                <div>
            ...
            <?php if (count($registros) > 0) : ?>
                <div class="my-10">
                    <h2 class="mb-4 text-lg leading-none text-gray-900 dark:text-white font-bold">Registros</h2>
                    <div>
                        <?php foreach ($registros as $registro): ?>
                            <div class="flex flex-col border-b border-gray-200 px-4 py-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 font-bold">
                                <p>Creado por: <span class="font-normal text-gray-900 dark:text-white"><?= $registro->empleado_id ?></span></p>
                                <p>Comentario: <span class="font-normal text-gray-900 dark:text-white"><?= $registro->comentario ?></span></p>
                                <p class="text-xs font-medium text-gray-600 dark:text-white"><?= $registro->created_at ?></p>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
