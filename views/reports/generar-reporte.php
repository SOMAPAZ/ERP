    ...
    <article class="mx-auto max-w-screen-lg px-4 2xl:px-0">
        ...
        <form class="mt-6" id="formulario-reporte" autocomplete="off" method="POST"">
            ...
            <div class="relative">
                ...
                <input type="text" id="nombre" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white uppercase" placeholder="John Wayne" />
            ...
            <div>
                ...
                <input type="number" id="idUser" name="idUser" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white uppercase" placeholder="7777" />
            ...
            <div>
                ...
                <input type="text" id="direccion" name="direccion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white uppercase" placeholder="La Concordia #42" />
            </div>
            <div>
                <label for="telefono" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número de Teléfono</label>
                <input type="tel" id="telefono" name="telefono" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white uppercase" placeholder="123 456 78 90" />
            </div>
            <div>
                <label for="beneficiario" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Beneficiario</label>
                <input type="text" id="beneficiario" name="beneficiario" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white uppercase" placeholder="Beneficiario de John Wayne" />
            </div>
            <div class="relative">
            ...
            <div>
                ...
                <textarea id="descripcion" name="descripcion" rows="4" class="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Escribe tu descripción aquí..."></textarea>
            </div>
