    ...
    if (isset($_POST['buscar'])) {
        ...
        $usuario = $_POST['usuario']; // Obtiene el valor de 'sac' del formulario POST.
        ...
        $resultados = mysqli_query($conexion, "SELECT * FROM info_usuarios WHERE usuario = '$usuario'");
