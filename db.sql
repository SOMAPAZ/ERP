CREATE TABLE IF NOT EXISTS billing (
  ...
  `water_late` decimal NOT NULL,
  `water_iva` decimal NOT NULL,
  `water_late_discount` decimal NOT NULL,
  `drain` decimal NOT NULL,
  `drain_late` decimal NOT NULL,
  `drain_late_discount` decimal NOT NULL,
  `drain_iva` decimal NOT NULL,
  `id_sanitation` decimal NOT NULL,
  `sanitation_late` decimal NOT NULL,
  `sanitation_late_discount` decimal NOT NULL,
  `sanitation_iva` decimal NOT NULL,
  `date_billing` datetime NOT NULL,
  `foliate` char NOT NULL,
  `id_agreement` bigint,
  `advance_payment` decimal,
  `advance_payment_water` decimal,
  `advance_payment_drain` decimal,
  `advance_payment_sanitation` decimal,
  `advance_payment_iva` decimal,
...
ALTER TABLE billing ADD CONSTRAINT billing_id_user_fk FOREIGN KEY (`id_user`) REFERENCES users (`idx`);
...
ALTER TABLE agreenmets ADD CONSTRAINT agreenmets_id_user_fk FOREIGN KEY (`id_user`) REFERENCES users (`idx`);
ALTER TABLE status_agreements ADD CONSTRAINT status_agreements_id_fk FOREIGN KEY (`id`) REFERENCES agreenmets (`id_status_agreement`);
...
ALTER TABLE employments ADD CONSTRAINT employments_id_fk FOREIGN KEY (`id`) REFERENCES billing (`id_employment`);
ALTER TABLE employments ADD CONSTRAINT employments_id_fk FOREIGN KEY (`id`) REFERENCES agreenmets (`id_employment`);